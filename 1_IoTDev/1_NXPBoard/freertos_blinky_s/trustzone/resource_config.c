...
#define SAU_REGION_1_END 0xEFFFFFFFU
#define SAU_REGION_2_BASE 0x1003FE00U
#define SAU_REGION_2_END 0x1003FFFFU
...
- ahb:
  - interrupts:
    - masking: {Non-masked: {id: [acmp_capt_irq, adc_irq, casper_irq, ctimer0_irq, ctimer1_irq, ctimer3_irq, ctimer4_irq, flexcomm0_irq, flexcomm1_irq, flexcomm2_irq,
  ...
  - regions: [{memory: PROGRAM_FLASH, security: s_priv, start: '0x00000000', size: '0x00040000'}, {memory: PROGRAM_FLASH, security: ns_user, start: '0x00040000',
    ...
    {memory: SRAM2, security: s_priv, start: '0x00000000', size: '0x00010000'}, {memory: SRAM3, security: ns_user, start: '0x00000000', size: '0x00010000'}, {memory: SRAM4,
  ...
  - peripherals: {ns_user: {id: [ADC0, AHB_SECURE_CTRL, ANACTRL, CRC_ENGINE, CTIMER0, CTIMER1, CTIMER3, CTIMER4, DBGMAILBOX, DMA0, DMA1, FLASH, FLEXCOMM0, FLEXCOMM1,
        FLEXCOMM2, FLEXCOMM3, FLEXCOMM5, FLEXCOMM6, FLEXCOMM7, GINT0, GINT1, GPIO, INPUTMUX, MAILBOX, MRT0, OSTIMER, PINT, PLU, PMC, POWERQUAD, PRINCE, PUF, RNG,
        SCT0, SDIF, SECGPIO, SECPINT, SPI8, SYSCON, SYSCTL, USB0, USBFSH, USBHSD, USBHSH, USBPHY, UTICK0, WWDT]}, s_priv: {id: [CASPER, CTIMER2, FLEXCOMM4, HASHCRYPT,
        IOCON, RTC]}}
- sau:
  - enabled: 'true'
  ...
  - regions: [{index: '0', enabled: 'true', security: ns, start: '0x00000000', size: '0x10000000'}, {index: '1', enabled: 'true', security: ns, start: '0x20000000',
      size: '0xD0000000'}, {index: '2', enabled: 'true', security: nsc, start: '0x1003FE00', size: '0x00000200'}, {index: '3', enabled: 'false', security: ns, start: '0x00000000',
...
- user_memory_regions: [{id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x0003FE00'}, {id: Region_2, security: nsc_priv, name: Veneer
      Table, start: '0x1003FE00', size: '0x00000200'}, {id: Region_3, security: s_priv, name: Secure Stack and Data, start: '0x30000000', size: '0x00030000'}, {id: Region_4,
  ...
  {id: Region_5, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege check is disabled so reset value (NS-User) can be used. ', start: '0x20030000',
    size: '0x00014000'}]
- mpus:
  - mpu:
    - enabled: 'false'
...
void BOARD_InitAHBSE()
{
    ...
    */
    ...
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE0_MEM_CTRL0 = 0xFCCCCCFCU;
    ...
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE1_MEM_CTRL1 = 0xFFCFFCCFU;
    ...
    AHB_SECURE_CTRL->SEC_CPU_INT_MASK1 = 0xFFFFFFEFU;
